...
class Parallax(Object):
    """Classe pour avoir un background animé."""
    def __init__(self, position: Point, vitesse: int):
        super().__init__(position, width=1200, height=1800)
        self.velocity = Vecteur(0, vitesse)

    def backInPosition(self):
        self.position = Point(0, -1800)
